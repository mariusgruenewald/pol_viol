...
# restrict data to those that are politically active/engaged
dat = dat[dat$active_environment==1 | dat$active_political==1 | dat$active_social==1 | dat$active_union==1,]
